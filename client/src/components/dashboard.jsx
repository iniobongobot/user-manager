...
const API_BASE = "http://localhost:3000/api/v3/users";
...
const UserManager = () => {
    ...
    // useCallback to memoize the fetchUsers function and prevent unnecessary re-renders
    const fetchUsers = useCallback(async () => {
        ...
        try {
            ...
            // this is my get all users function.
            // this will be called everytime a change i s made.
        ...
        try {
            if (editingUser) {
                ...
                setModalInfo({
                        show: true,
                        title: "Success",
                        message: "User record has been successfully created.",
                        isError: false
                    });
            }
            setShowModal(false);
                        ...
                        <div className="card-body px-4">
                            ...
                            <div className="row g-3">
                                <div className="col-md-6">
                                    ...
                                    <input 
                                        className="form-control" 
                                        placeholder="e.g. iniobongobot@sas.com"
                                        type="email" 
                                        required 
        ...
        {modalInfo.show && (
            <div className="modal fade show d-block" style={{ backgroundColor: 'rgba(0,0,0,0.5)' }} tabIndex="-1">
                ...
                <div className="modal-content">
                    <div className={`modal-header ${modalInfo.isError ? 'bg-danger text-white' : 'bg-success text-white'}`}>
